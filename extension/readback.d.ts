...
export interface BrowserReadback {type:'readback';challenge_id:string;observed_at:string;tabs:BrowserTabReadback[];present_tabs:number[];instances:{tab_id:number;action_ref:BrowserActionRef}[];focused_window:number;complete:boolean;stable:boolean}
