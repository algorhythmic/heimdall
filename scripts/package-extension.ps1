...
$files = @('manifest.json','extension-id.txt','worker.js','controller.js','action-protocol.js','readback.js','outbox.js','popup.html','popup.js','popup.css','launch.html') | ForEach-Object { Join-Path $projectRoot ('extension/' + $_) }
