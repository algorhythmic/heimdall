...
performs no application action. Recovery preview and execution are delivered through W04–W07;
see [preview](WORKSPACE-PREVIEW.md) and [operations](WORKSPACE-OPERATIONS.md).
...
gates in [the roadmap](../HEIMDALL-IMPLEMENTATION-ROADMAP.md).
