...
Source of truth for this review: `types.go` (historical source path: `../../../../Braid Retrieval Engine/pkg/braid/types.go`; unavailable checkout), `main.go` (historical source path: `../../../../Braid Retrieval Engine/cmd/braid/main.go`; unavailable checkout), `projection.go` (historical source path: `../../../../Braid Retrieval Engine/pkg/braid/projection.go`; unavailable checkout), `config.go` (historical source path: `../../../../Braid Retrieval Engine/pkg/braid/config.go`; unavailable checkout), and implementation notes (historical source path: `../../../../Braid Retrieval Engine/docs/implementation.md`; unavailable checkout).
...
Run verify-braid.ps1 (historical source path: `../../../../Braid Retrieval Engine/docs/heimdall/verify-braid.ps1`; unavailable checkout) to check the actual subprocess contract and replay caveat against the local Braid source. It uses a temporary isolated database, not user state.
