...
Companion: [Omarchy workflow assessment](OMARCHY-WORKFLOW-ASSESSMENT.md). Governing interfaces: [Viewport and workspace manifests](../design-v1/HANDOFF-heimdall-v1.1.md), [implementation plan](../roadmaps/IMPLEMENTATION-PLAN.md), and [backlog](../../BACKLOG.md).
