...
export function requestFingerprint(op: {id: string; epoch: string; action: string; expires_at: string; tab_id?: number; window_id?: number; owner_id?: string; expected_url?: string; url?: string; action_ref?: BrowserActionRef}): string;
