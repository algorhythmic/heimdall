...
| Workspace/session identity | Initial W01/T02 delivered: explicit manifests, generic declarations and verified local Herdr bindings with refresh/metadata. Schema-9 migration/replay tested. W02 adds read-only Hyprland observation and explicit viewport binding. W03 adds durable manual points and opt-in autosnapshots. W04 adds scoped List/Diff/preview and stale-plan validation. W05 adds journaled native focus/close and capacity reservations; W06 adds reviewed application adapters. Full recovery verification remains W07. |
