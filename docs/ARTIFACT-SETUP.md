...
Database markers 1–13 upgrade to **14**, after a consistent
`backups/pre-schema-14-*.db` is published under the writer lock. A failed backup
aborts migration. Older binaries refuse marker 14. Roll back by stopping the
