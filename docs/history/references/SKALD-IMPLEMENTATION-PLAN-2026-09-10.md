...
in [STATUS.md](../../../../skald/STATUS.md); planned features below are not claims of completion.
This is the Heimdall reference copy; Skald owns delivery status and implementation.
The sibling plan is synchronized for this design review.

Companion document: [Heimdall design amendment](../../design/SKALD-HEIMDALL-AMENDMENT.md).
...
Reviewed design studies: [project/session overview](../../../../skald/skald-window.html) and
[transcript reader](../../../../skald/skald-transcript.html). Retain the warm monochrome terminal,
...
Implementation update: the first L1 archive/daemon slice now runs. See
[archive setup](../../../../skald/docs/ARCHIVE-SETUP.md) and [status](../../../../skald/STATUS.md) for verified
...
See [current backlog](../../BACKLOG.md) and [status](../../STATUS.md).
...
exist in Skald; see [contract details](../../../../skald/docs/CONTRACT-V1.md) and
[delivery status](../../../../skald/STATUS.md) for the implemented subset and remaining freeze gates.
...
[README.md](../../../../skald/README.md); service operations below remain planned for L1–L3.
...
- [Heimdall amendment](../../design/SKALD-HEIMDALL-AMENDMENT.md), including proposed
  changes to r4 rather than a claim that those changes are already implemented.
- [Heimdall status](../../STATUS.md), [backlog](../../BACKLOG.md) and
  [current handoff r4](../../design/HANDOFF-heimdall-v1-r4.md).
...
- [Dotprivate README](../../../../dotprivate/README.md) and
  ...
  [Heimdall's existing manual preservation workflow](../../guides/PRESERVATION-SETUP.md).
