...
[verification](../VERIFICATION.md), and [roadmap dependency gates](../HEIMDALL-IMPLEMENTATION-ROADMAP.md).

Future automation depends on the proposed [dotprivate-owned selected-files contract](../../../dotprivate/docs/SELECTED-FILES-CONTRACT.md) and its released implementation. This guide remains the implemented manual workflow; no automatic Git operation is added.
