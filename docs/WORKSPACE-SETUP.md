...
- Database marker 11 retains workspace/session, observed Herdr records and [P01 artifacts](ARTIFACT-SETUP.md), and adds [P02 progress review](PROGRESS-SETUP.md). Before upgrading an
  existing marker 1–8 database, Heimdall creates a consistent
  `backups/pre-schema-11-*.db`. Older binaries refuse marker 11. To roll back, stop
