...
- Database marker 9 retains workspace/session and observed Herdr records and adds [P01 artifacts](ARTIFACT-SETUP.md). Before upgrading an
  existing marker 1–8 database, Heimdall creates a consistent
  `backups/pre-schema-9-*.db`. Older binaries refuse marker 9. To roll back, stop
