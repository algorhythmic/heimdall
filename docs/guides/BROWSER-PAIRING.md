# Browser window pairing

C13 (introduced at schema 18; current schema 21, extension 0.6.0) joins an explicitly authorized browser action to the selected Hyprland
...
and fresh membership verification are delivered through W05–W07; see
[application recovery](APPLICATION-RECOVERY.md) and [W07 verification](../RECOVERY-VERIFICATION.md).
